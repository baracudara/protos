...
type RegisterRequest struct {
	...
	Passwod       string                 `protobuf:"bytes,2,opt,name=passwod,proto3" json:"passwod,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterRequest) GetPasswod() string {
	if x != nil {
		return x.Passwod
	}
	return ""
...
func (x *LoginRequest) GetPasswod() string {
	if x != nil {
		return x.Passwod
	}
	return ""
...
func (x *LogoutRequest) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\apasswod\x18\x02 \x01(\tR\apasswod\"+\n" +
	"\x10RegisterResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"U\n" +
	"\fLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x18\n" +
	"\apasswod\x18\x02 \x01(\tR\apasswod\x12\x15\n" +
	...
	"\aisAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB)Z'github.com/baracudara/protos/gen/go/ssob\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	6, // 6: auth.Auth.Logout:output_type -> auth.LogoutResponse
